...
<p>Tahun ini, program berbagi takjil diperluas dengan melibatkan donasi dari warga masyarakat. Setiap RT mengumpulkan sumbangan berupa makanan ringan dan minuman yang kemudian dikemas oleh anggota Karang Taruna.</p>

<p>Ketua Karang Taruna, Budi Santoso, menyampaikan bahwa kegiatan ini merupakan wujud nyata kepedulian pemuda terhadap sesama. "Ini adalah momen kita untuk berbagi kebahagiaan, sekecil apa pun bentuknya," ujarnya.</p>

<h3>Dukungan Warga</h3>

<p>Antusiasme warga terhadap program ini sangat tinggi. Banyak warga yang secara sukarela membantu menyiapkan takjil dan membagikannya di lokasi yang telah ditentukan. Kerja sama antar-warga ini menjadi semangat baru bagi anggota Karang Taruna untuk terus berkontribusi.</p>`,
    image: null,
    imageAlt: "Anggota Karang Taruna membagikan takjil gratis kepada pengguna jalan",
  },
  {
    id: 2,
...
<p>Turnamen menggunakan sistem gugur dengan 4 grup yang masing-masing berisi 4 tim. Pertandingan digelar setiap hari Sabtu dan Minggu selama satu bulan penuh, dari tanggal 20 Februari hingga 22 Maret 2026.</p>

<p>Budi Santoso selaku ketua pelaksana menjelaskan bahwa turnamen ini bukan sekadar kompetisi, tapi juga ajang membangun kebersamaan antar warga. "Setiap RT punya kesempatan yang sama untuk menunjukkan semangat sportivitas," katanya.</p>

<h3>Antusiasme Peserta</h3>

<p>Tahun ini, antusiasme peserta meningkat signifikan dibanding tahun sebelumnya. Dari 10 tim pada 2025, kini menjadi 16 tim yang mendaftar. Beberapa tim bahkan sudah melakukan latihan rutin sejak sebulan sebelum turnamen dimulai.</p>`,
    image: null,
    imageAlt: "Suasana pertandingan futsal antar-RT dalam Turnamen Piala Karang Taruna",
  },
  {
    id: 3,
    slug: "bakti-sosial-pemberian-sembako",
    title: "Bakti Sosial: Pembagian Sembako untuk Warga Terdampak",
    category: "Sosial",
    date: "2026-02-05",
...
<p>Dana untuk pembelian sembako bersumber dari iuran anggota, donasi warga masyarakat, dan sumbangan dari beberapa donatur yang peduli. Total dana yang terkumpul mencapai Rp 8.500.000 yang seluruhnya digunakan untuk pembelian paket sembako.</p>

<p>Ketua Karang Taruna menyampaikan terima kasih atas kepedulian semua pihak. "Bakti sosial ini adalah agenda rutin kami, dan kami berkomitmen untuk terus membantu warga yang membutuhkan," ujarnya.</p>
...
<p>Kegiatan bakti sosial ini mendapat sambutan hangat dari warga dan apresiasi dari pemerintah kelurahan. Lurah Mekar Jaya menyampaikan bahwa kegiatan seperti ini perlu dilestarikan dan menjadi contoh bagi organisasi pemuda lainnya.</p>`,
  ...
  {
    id: 4,
    slug: "pemilihan-pengurus-baru-2026",
    title: "Musyawarah Besar dan Pemilihan Pengurus Baru Periode 2026-2028",
...
<h3>Hasil Musyawarah</h3>

<p>Mubes menghasilkan beberapa keputusan penting, antara lain penambahan divisi Digital dan Media Sosial, peningkatan frekuensi kegiatan sosial menjadi bulanan, serta alokasi anggaran yang lebih besar untuk program pemberdayaan pemuda.</p>

<p>Selain itu, Mubes juga menetapkan program unggulan untuk 2026, yaitu Pelatihan Digital Marketing untuk 50 pemuda, Program Kewirausahaan Pemuda, dan Penguatan Bank Sampah di tingkat RT.</p>
...
<p>Ketua terpilih menyampaikan visinya untuk menjadikan Karang Taruna Mekar Jaya sebagai organisasi yang lebih profesional, transparan, dan berdampak nyata bagi masyarakat. "Kami akan bekerja lebih keras dan lebih cerdas untuk memenuhi harapan seluruh anggota dan masyarakat," tegasnya.</p>`,
  ...
  {
    id: 5,
    slug: "program-penanaman-pohon-seribu-pohon",
    title: "Program Seribu Pohon: Karang Taruna Tanam Pohon di Sepanjang Jalan Desa",
    category: "Lingkungan",
    date: "2025-12-15",
    author: "Rizki Pratama",
...
<p>Keberhasilan program ini tidak lepas dari keterlibatan aktif seluruh elemen masyarakat. Setiap RT menugaskan minimal 5 orang untuk terlibat dalam setiap sesi penanaman. Siswa sekolah dasar juga turut serta dalam program edukasi lingkungan yang menyertai kegiatan penanaman.</p>

<p>Monitoring dan perawatan pohon dilakukan secara berkala setiap bulan oleh tim khusus yang terdiri dari 10 anggota Karang Taruna. Tingkat hidup pohon hingga saat ini mencapai 92%, angka yang cukup baik untuk program penanaman skala komunitas.</p>

<h3>Dampak Lingkungan</h3>

<p>Program ini telah memberikan dampak positif yang terukur, termasuk peningkatan kualitas udara di sekitar area penanaman, berkurangnya suhu panas di area jalan desa, dan meningkatnya kesadaran warga akan pentingnya menjaga kelestarian lingkungan.</p>`,
    image: null,
    imageAlt: "Anggota Karang Taruna sedang menanam pohon di tepi jalan desa",
  },
  {
    id: 6,
    slug: "bimbingan-belajar-anak-meningkat",
    title: "Program Bimbingan Belajar Anak Mencapai 50 Peserta Aktif",
    category: "Sosial",
    date: "2025-11-20",
    author: "Siti Nurhaliza",
...
<p>Keberhasilan program ini tidak terlepas dari 8 orang tutor relawan yang terdiri dari mahasiswa dan profesional muda di lingkungan sekitar. Mereka mengajar dengan penuh dedikasi dan membimbing anak-anak sesuai dengan tingkat kemampuan masing-masing.</p>

<p>Setiap sesi bimbingan belajar diawali dengan doa bersama dan diakhiri dengan motivasi singkat. Para orang tua juga dilibatkan melalui komunikasi rutin via grup WhatsApp untuk memantau perkembangan anak-anak mereka.</p>

<h3>Pencapaian</h3>

<p>Berdasarkan evaluasi yang dilakukan setiap akhir semester, rata-rata nilai siswa mengalami peningkatan sebesar 15% dari awal mengikuti program. Beberapa siswa bahkan masuk peringkat 5 besar di kelas masing-masing.</p>`,
    image: null,
    imageAlt: "Suasana bimbingan belajar anak di sekretariat Karang Taruna",
  },
];
