  ...
  const jsonLd = useMemo(() => [
    {
      ...
      alternateName: ['Karang Taruna Mangga Dua', 'Karang Taruna Mangga Dua Selatan', 'Karang Taruna Unit 01', 'Katar Mangga Dua Selatan Unit 01', 'KT Mangga Dua Selatan'],
      keywords: 'Karang Taruna Mangga Dua, Karang Taruna Mangga Dua Selatan, Karang Taruna Unit 01, Katar Mangga Dua Selatan, Pemuda Mangga Dua Selatan',
      url: SITE_URL,
